    ...
    cartBtn.addEventListener('click', (e) => {
      ...
      if (currentPlant) {
        addToCart(
          ...
          currentPlant.name,
          currentPlant.price,
          currentPlant.images[0] || '../assets/images/product-preview.png',
          currentPlant.stock
        );
      }
    });
    ...
    if (mainContainer) {
      mainContainer.innerHTML = `
        <div style="text-align: center; padding: 80px 20px; color: var(--color-danger);">
          ...
          <a href="plants.html" class="btn btn-secondary btn-sm mt-3" style="display:inline-flex; width:auto;">Return to Catalog</a>
        </div>
      `;
    }
  }
...
function renderPlantDetails(plant) {
  ...
  if (imgElement) {
    imgElement.src = plant.images[0] || '../assets/images/product-preview.png';
